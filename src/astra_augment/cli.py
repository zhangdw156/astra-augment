...
@click.option("--ratio", required=True, type=float, help="Fraction of tail positions to expand (0, 1].")
@click.option("--mode", required=True, type=click.Choice(["tool_call", "response"]), help="Truncation mode.")
@click.option("--format", "fmt", default="qwen3", type=click.Choice(["qwen3"]), help="Dataset format.")
